...
function EditarPerfil() {
    ...
    function getUser() {
        ...
        fetch(url, {
            ...
            setCpfResponsavel(data.cpf_res)
            setEmailResponsavel(data.email_res)
            setRgResponsavel(data.rg_res)
            setNomeResponsavel(data.nome_res)
            var partesDataRes = data.data_nac_res.split("T")[0];
